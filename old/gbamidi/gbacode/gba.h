...
#define REG_TM1CNT     *(u32*)0x4000104		//Timer 1
#define REG_TM1CNT_L   *(u16*)0x4000104		//Timer 1 count value
#define REG_TM1CNT_H   *(u16*)0x4000106		//Timer 1 control

#define REG_TM2CNT     *(u32*)0x4000108		//Timer 2
#define REG_TM2CNT_L   *(u16*)0x4000108		//Timer 2 count value
#define REG_TM2CNT_H   *(u16*)0x400010a		//Timer 2 control

#define REG_TM3CNT     *(u32*)0x400010c		//Timer 3
#define REG_TM3CNT_L   *(u16*)0x400010c		//Timer 3 count value
#define REG_TM3CNT_H   *(u16*)0x400010e		//Timer 3 control
